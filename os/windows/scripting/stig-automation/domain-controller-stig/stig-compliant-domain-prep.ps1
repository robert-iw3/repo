...
.DESCRIPTION
    ...
    Import all the GPOs to assist in making your
    ...
    Do not run this script if you don't understand what it does.
...
.INPUTS
    ...
    None. You cannot pipe objects into stig-compliant-domain-prep.ps1.
...
.EXAMPLE
    ...
    PS> .\stig-compliant-domain-prep.ps1 -logFile 'YYYYmmdd_prep.log'
    ...
    try {
        ...
        foreach ($gpoCategoryDir in $gpoCategoryDirs) {
            ...
            foreach ($gpoFile in $gpoFiles) {
                ...
                New-GPO -Name $gpoName -Comment "Created by make_stigs_easier"
