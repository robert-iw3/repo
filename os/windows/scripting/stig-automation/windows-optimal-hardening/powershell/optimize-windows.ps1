...
if ($sysmon -eq $true) {
    Write-Host "Implementing make_stigs_easier/Automate-Sysmon" -ForegroundColor Green
    Write-Host "https://github.com/make_stigs_easier/Automate-Sysmon" -ForegroundColor Green
