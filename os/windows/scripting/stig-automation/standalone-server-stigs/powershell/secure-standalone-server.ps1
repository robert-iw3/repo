...
if ($firefox -eq $true) {
    ...
    Write-Host "make_stigs_easier/FireFox-STIG-Script" -ForegroundColor Green
    Write-Host "https://github.com/make_stigs_easier/FireFox-STIG-Script" -ForegroundColor Green
...
if ($dotnet -eq $true) {
    ...
    #make_stigs_easier - Microsoft .Net Framework 4 STIG Script
    #https://github.com/make_stigs_easier
    ...
    Write-Host "Implementing make_stigs_easier/.NET-STIG-Script" -ForegroundColor Green
    Write-Host "https://github.com/make_stigs_easier/.NET-STIG-Script" -ForegroundColor Green
...
if ($java -eq $true) {
    ...
    Write-Host "Implementing make_stigs_easier/JAVA-STIG-Script" -ForegroundColor Green
    Write-Host "https://github.com/make_stigs_easier/JAVA-STIG-Script" -ForegroundColor Green
...
if ($windows -eq $true) {
    ...
    Write-Host "Implementing make_stigs_easier/Windows-Audit-Policy" -ForegroundColor Green
    Write-Host "https://github.com/make_stigs_easier/Windows-Audit-Policy" -ForegroundColor Green
...
if ($sosoptional -eq $true) {
    Write-Host "Implementing the Optional make_stigs_easier Configurations Section" -ForegroundColor Green
    Import-GPOs -gposdir ".\Files\GPOs\SoS"
}
else {
    Write-Output "The Optional make_stigs_easier Configurations Section Was Skipped..."
}
