...
- Import the ADMX Policy definitions from this into _C:\windows\PolicyDefinitions_ on the system you're trying to modify.
...
powershell.exe -ExecutionPolicy ByPass -File .\optimize-windows.ps1 -cleargpos:$false -installupdates:$false
```
