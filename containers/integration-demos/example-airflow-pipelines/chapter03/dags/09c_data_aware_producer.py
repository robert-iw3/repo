...
events_dataset = Dataset("/data/09_data_aware/events/09c")
...
with DAG(
    dag_id="09c_data_aware_producer",
    schedule="@daily",
    ...
    fetch_events = PythonOperator(
        ...
        op_kwargs={
            ...
            "output_path": "/data/09_data_aware/events/09c/{{ data_interval_start | ds }}.json",
        },
