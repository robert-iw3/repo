...
variable "db_secret_1_arn" {
  ...
  type        = string
  default     = "arn:aws:secretsmanager:us-west-1:080129930438:secret:keycloak-rds-1-clsfF0"
}
...
variable "keycloak_secret_1_arn" {
  ...
  type        = string
  default     = "arn:aws:secretsmanager:us-west-1:080129930438:secret:keycloak-1-JBbfS5"
}
...
variable "keycloak_external_url" {
  ...
  type        = string
  default     = "https://prod.keycloak.io"
}
