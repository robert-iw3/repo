...
# Parse Arguments
parser = argparse.ArgumentParser(description="yara-scanner: Simple IOC and YARA scanner")
...
parser.add_argument(
    "--pidfile", help="Pid file path (default: yara-scanner.pid)", default="yara-scanner.pid"
)
parser.add_argument(
    "--listen-host",
...
parser.add_argument(
    ...
    "(even if excluded with hard exclude in yara-scanner's code",
    default=False,
)
parser.add_argument(
    "--version",
    action="store_true",
    help="Shows welcome text and version of yara-scanner, then exit",
    default=False,
)
parser.add_argument(
    "--progress",
...
parser.add_argument(
    "--multicore",
    action="store_true",
    help="Force yara-scanner to use all CPU cores (experimental)",
    default=False,
)
parser.add_argument(
    "--followlinks",
    action="store_true",
    help="Force yara-scanner to follow symlinks (be aware: may lead to RAM overflow)",
    default=False,
)
parser.add_argument(
    "--custom",
