        ...
        try:
            ...
            with codecs.open(self.log_file, "a", encoding="utf-8") as logfile:
                if self.csv:
                    ...
                    logfile.write(
                        self.log_format(
                            "{0} {1} yara-scanner: {2}: MODULE: {3} MESSAGE: {4}{5}",
                            get_syslog_timestamp(),
                            os.uname().nodename,
                            mes_type.title(),
                            module,
    ...
    def print_results(self) -> None:
        ...
        if self.alerts:
            ...
            self.log(
                "RESULT",
                "Results",
                "yara-scanner recommends checking the elements on virustotal.com "
            ...
            self.log(
                "RESULT",
                "Results",
                "yara-scanner recommends a deeper analysis of the suspicious objects.",
            )
        else:
        ...
        self.log(
            "NOTICE",
            "Results",
            f"Finished yara-scanner Scan SYSTEM: {os.uname().nodename} TIME: {get_syslog_timestamp()}",
        )
