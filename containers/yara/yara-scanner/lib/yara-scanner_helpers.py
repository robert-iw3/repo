...
def yara-scanner_generate_hashes(filedata: bytes) -> tuple[str, str, str]:
    """
    generate hashes
    """
    try:
...
def yara-scanner_get_excluded_mountpoints() -> list[str]:
    """
...
def yara-scanner_print_progress(i: int) -> None:
    """
...
def yara-scanner_transform_os(regex: str) -> str:
    """
...
def yara-scanner_replace_env_vars(path: str) -> str:
    """
...
def yara-scanner_get_file_type(
...
def yara-scanner_remove_non_ascii_drop(s) -> str:
    """
    remove non-ascii
    """
    nonascii = "error"
...
def yara-scanner_get_age(file_path: str) -> tuple[float, float, float]:
    """
    get age
    """
    try:
...
def yara-scanner_get_age_string(file_path: str) -> str:
    """
    get age string
    """
    (ctime, mtime, atime) = yara-scanner_get_age(file_path)
    timestring = ""
    try:
        timestring = (
