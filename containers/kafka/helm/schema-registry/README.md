...
Schema Registry lives outside of and separately from your Kafka brokers. By default this chart is set to use the umbrella chart [kstack](/helm-charts/charts/kstack), but can be run against an external Kafka by:
