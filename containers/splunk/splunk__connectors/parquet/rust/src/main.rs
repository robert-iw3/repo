...
async fn main() -> Result<()> {
    ...
    let splunk_url = env::var("SPLUNK_HEC_URL")
        .unwrap_or_else(|_| "https://your-splunk-host:8088/services/collector/event".to_string());
    let splunk_token = env::var("SPLUNK_TOKEN")
        .unwrap_or_else(|_| "your-splunk-hec-token".to_string());
    ...
    // Start sender
    let sender_task = tokio::spawn(sender::send_to_splunk(
        rx,
        splunk_url,
        splunk_token,
        batch_size,
