...
def deploy_ansible(config):
    ...
    subprocess.run(['ansible-playbook', 'deploy_json_connectors.yml', '-e', f"config_file={os.path.abspath('deploy_config.yaml')}"], check=True)
...
def main():
    ...
    config_files = [
        ...
        'schemas.yaml',
        'json_splunk_connector.py',
        'json_elasticsearch_connector.py',
