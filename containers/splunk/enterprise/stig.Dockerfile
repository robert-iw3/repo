...
LABEL \
    org.opencontainers.image.name='Splunk' \
    org.opencontainers.image.description='The Unified Security and Observability Platform.' \
    org.opencontainers.image.usage='https://docs.splunk.com/Documentation/Splunk' \
    ...
    org.opencontainers.image.schema-version='10.0.1'

ENV SPLUNK_PRODUCT splunk
ENV SPLUNK_VERSION 10.0.1
ENV SPLUNK_BUILD c486717c322b
ENV SPLUNK_FILENAME splunk-${SPLUNK_VERSION}-${SPLUNK_BUILD}-linux-amd64.tgz
...
RUN \
    ...
    microdnf remove -y clamav clamav-update openscap scap-security-guide wget; \
    /usr/bin/crb disable; \
...
# Copy new license
#COPY ./Splunk_Enterprise_Q3FY24.lic /var/opt/splunk/etc/licenses/download-trial/Splunk_Enterprise_Q3FY24.lic

# Ports Splunk Web, Splunk Daemon, KVStore, Splunk Indexing Port, Network Input, Cribl Syslog, HTTP Event Collector
EXPOSE 8000/tcp 8089/tcp 8191/tcp 9997/tcp 1514/tcp 8088/tcp
