...
variable "nextcloud_secret_1_arn" {
  description = "The ARN of the AWS Secrets Manager secret that contains the credentials for the Nextcloud"
  type        = string
  default     = "arn:aws:secretsmanager:YOUR-REGION-X:000000000000:secret:nextcloud-1-000000"
}
...
variable "subnet_group_1_name" {
  ...
  type        = string
  default     = "subnet-group-nextcloud-1"
}

variable "subnet_group_2_name" {
  description = "The name of the DB subnet group"
  type        = string
  default     = "subnet-group-nextcloud-2"
}
...
variable "nextcloud_external_url" {
  ...
  type        = string
  default     = "https://prod.nextcloud.net"
}
