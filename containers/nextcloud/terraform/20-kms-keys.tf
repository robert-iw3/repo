...
resource "aws_kms_alias" "kms_key_1_alias" {
  name          = "alias/terraform-bucket-key-nextcloud-1"
...
resource "aws_kms_alias" "kms_key_2_alias" {
  name          = "alias/dynamodb-table-encryption-nextcloud-1"
...
resource "aws_kms_alias" "kms_key_4_alias" {
  name          = "alias/ebs-1-volume-encryption-nextcloud-1"
...
resource "aws_kms_alias" "kms_key_5_alias" {
  name          = "alias/backup-ebs-volume-1-encryption-nextcloud-1"
