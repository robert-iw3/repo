...
from sender import send_to_elastic
...
async def main():
    ...
    try:
        ...
        es_index = os.getenv("ES_INDEX", "parquet-logs")
        es_auth = os.getenv("ES_AUTH", None)  # Format: "username:password" or "api_key"
        ...
        sender_task = asyncio.create_task(
            send_to_elastic(queue, es_host, es_index, batch_size, buffer_timeout, es_auth)
        )
