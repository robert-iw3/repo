...
export JAVA_BASE_DIR="${_root_dir}/java"
export JAVA_BIN_DIR="${JAVA_BASE_DIR}/bin"
export PYTHON_BASE_DIR="${_root_dir}/python"
...
export PATH="${DB_BIN_DIR}:${_root_dir}/common/bin:${_root_dir}/python/bin:${_root_dir}/java/bin:$PATH"
...
export SCYLLADB_ENV_FILE="${DB_CONF_DIR}/cassandra-env.sh"
